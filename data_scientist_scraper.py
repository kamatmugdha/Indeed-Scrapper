...
TEAM 1
author : Mugdha
script for scrapping data scientist job title and description
"""
...
def scrape(url):
    ...
    fw = open('data_scientist.csv', 'a', encoding='utf8')
...
url = "https://www.indeed.com/jobs?q=data+scientist&l=Richmond%2C+VA"
scrape(url)